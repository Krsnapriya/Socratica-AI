...
export default class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.error) {
      return (
        <div className="flex h-screen items-center justify-center p-8 text-center" style={{ background: 'var(--background)' }}>
          <div className="max-w-md w-full">
            ...
            <p className="text-on-surface-variant text-sm mb-4">
              An unexpected error occurred. Please try going home or refreshing the page.
            </p>
            ...
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="px-4 py-2 font-mono text-sm font-bold rounded-lg text-on-surface bg-surface-container border border-outline-variant hover:opacity-90"
              >
                Go Home
              </button>
              <button
